<%@ Page Language="C#" AutoEventWireup="true" CodeFile="turguncelle.aspx.cs" Inherits="admin_turguncelle" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mehmet Tours - Tur Güncelle</title>
        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <%--<input runat="server" maxlength="50" type="text" required="required" class="form-control" name="turAdi" id="txtTurAdi" placeholder="Doğa Turu" />--%>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <%--<textarea runat="server" type="text" required class="form-control" id="txtTurAciklama" name="turAciklama" placeholder="3 gün sürecek doğa turu" />--%>
                </div>
            </div>
            <div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <%--<input runat="server" type="text" required id="txtTurFiyat" class="form-control" name="turFiyat" placeholder="2500₺" />--%>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <asp:FileUpload runat="server" required="" ID="turResim" CssClass="form-control" />
                            </div>
                        </div>
                        <div>
                    ...
                    <asp:Button runat="server" ID="buttonGuncelle" Text="Güncelle" CssClass="btn btn-primary" OnClick="buttonGuncelle_Click" />
                </div>
            </div>
        </div>
    </form>
