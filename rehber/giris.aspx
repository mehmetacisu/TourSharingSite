<%@ Page Language="C#" AutoEventWireup="true" CodeFile="giris.aspx.cs" Inherits="rehbergiris" %>
...
<head runat="server">
    ...
    <title>Mehmet Tours - Rehber Panel Giriş</title>
    ...
    <form id="form1" runat="server" method="post">
        <div class="container h-100 col-sm-6 col-sm-3 ">
            <div class="row  d-flex justify-content-center align-items-center h-100 text-center" style="margin-top: 20%;">
                ...
                <asp:Label ID="Label1" runat="server" Text="Mehmet Tours Rehber Girişi" Font-Bold="true" Font-Size="Large" CssClass="text-primary mb-4"></asp:Label>
